...
insert into bank_account_type (id, name, transactions_commission) values (1, 'Czar', 0.01);
insert into bank_account_type (id, name, transactions_commission) values (2, 'Nobleman', 0.02);
insert into bank_account_type (id, name, transactions_commission) values (3, 'Junker', 0.03);
insert into bank_account_type (id, name, transactions_commission) values (4, 'Standard', 0.04);
insert into bank_account_type (id, name, transactions_commission) values (5, 'Unused account type', 0.10);
